...
$APPLICATION->IncludeAdminFile("Установка модуля галереи от Студии 101", $DOCUMENT_ROOT."/bitrix/modules/dv_module/install/step.php");
}
...
$APPLICATION->IncludeAdminFile("Деинсталляция модуля модуля галереи от Студии 101", $DOCUMENT_ROOT."/bitrix/modules/dv_module/install/unstep.php");
}
}
?>